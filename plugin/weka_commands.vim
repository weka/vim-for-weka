...
command! -bar -nargs=? WekaInvestigate call weka#openTerminalForJob('investigate %s', <q-args>)
command! -bar -nargs=? WekaStress0Explore call weka#openTerminalForJob('stress0 explore %s', <q-args>)
